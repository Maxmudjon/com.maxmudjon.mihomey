...
class PhilipsLEDBulbE14CandleLampCrystal extends Homey.Driver {
  onInit() {
    this.actions = {
  ...
  onPair(socket) {
    let pairingDevice = {};
    pairingDevice.name = "Philips Candle Lamp Crystal";
          ...
          device
            ...
            .then(value => {
              if (value.model == this.data.model) {
                pairingDevice.data.id = "PH:LB:CL:WC:" + value.mac + ":PH:LB:CL:WC";
                device
                ...
                let result = {
                  notDevice: "It is not Philips Candle Lamp Crystal"
                };
