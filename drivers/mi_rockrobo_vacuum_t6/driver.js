...
class MiRockRoboVacuumT6 extends Homey.Driver {
  onInit() {
    this.triggers = {
  ...
  onPair(socket) {
    let pairingDevice = {};
    pairingDevice.name = "Mi Roborock Vacuum T6";
          ...
          device
            ...
            .then((value) => {
              if (value.model == this.data.model) {
                pairingDevice.data.id = "MI:VC:T6:" + value.mac + ":MI:VC:T6";
                device
                  .call("get_status", [])
                  .then((value) => {
                    let result = {
                ...
                let result = {
                  notDevice: "It is not Mi Roborock Vacuum T6",
                };
