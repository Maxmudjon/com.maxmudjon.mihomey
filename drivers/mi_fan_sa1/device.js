...
class MiFanSA1 extends Homey.Device {
  async onInit() {
  ...
  getHumidifierStatus() {
    miio
      ...
      .then((device) => {
        ...
        this.device
          .call("get_prop", ["led", "angle", "speed", "poweroff_time", "power", "ac_power", "angle_enable", "speed_level", "natural_level", "child_lock", "buzzer", "led_b", "use_time"])
          .then((result) => {
            this.log(this.getName(), result);
          })
