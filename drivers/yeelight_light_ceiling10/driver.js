...
class YeelightCrystalPendantLamp extends Homey.Driver {
  onInit() {
    this.actions = {
  ...
  onPair(socket) {
    let pairingDevice = {};
    pairingDevice.name = "Yeelight Crystal Pendant Lamp";
          ...
          device
            ...
            .then(value => {
              if (value.model == this.data.model) {
                pairingDevice.data.id = "YC:PL:" + value.mac + ":YC:PL";
                device
                ...
                let result = {
                  notDevice: "It is not Yeelight Crystal Pendant Lamp"
                };
...
module.exports = YeelightCrystalPendantLamp;
