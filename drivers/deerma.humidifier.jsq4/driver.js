...
class MiSmartEvaporativeHumidifer extends Homey.Driver {
  onInit() {
    this.actions = {
  ...
  onPair(socket) {
    let pairingDevice = {};
    pairingDevice.name = "Mi Smart Evaporative Humidifer";
          ...
          device
            ...
            .then((value) => {
              if (value.model == this.data.model) {
                ...
                let result = {
                  notDevice: "It is not Mi Smart Evaporative Humidifer",
                };
